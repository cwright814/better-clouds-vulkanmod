...
find fabric/build/libs -name "better-clouds-*.jar" ! -name "*-sources.jar" -exec cp {} /home/cwright/Projects/sandbox/better-clouds-vulkanmod-${MOD_VERSION}+26.1.2-fabric.jar \;
