...
void main() {
    ...
    // Debug: tint the world red based on CloudShadowsEnabled
    if (CloudShadowsEnabled > 0.5) {
        color.rgb = vec3(1.0, 0.0, 0.0); // Make everything RED to prove the shader works
    }
